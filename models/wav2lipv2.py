...
class Wav2Lip(nn.Module):
    ...
    def __init__(self):  # TODO 网络调整较大
        ...
        self.face_encoder_blocks = nn.ModuleList([
            ...
            nn.Sequential(
                Conv2d(32, 32, kernel_size=3, stride=2, padding=1),  # 72,72
                Conv2d(32, 32, kernel_size=3, stride=1, padding=1, residual=True),
                Conv2d(32, 32, kernel_size=3, stride=1, padding=1, residual=True)
            ),
            ...
            nn.Sequential(
                Conv2d(512, 512, kernel_size=3, stride=1, padding=0),  # 3, 3
...
class Wav2Lip_disc_qual(nn.Module):
    ...
    def __init__(self):
        ...
        self.face_encoder_blocks = nn.ModuleList([
            ...
            nn.Sequential(
                nonorm_Conv2d(32, 64, kernel_size=5, stride=(1, 2), padding=2),  # 144, 144
                nonorm_Conv2d(64, 64, kernel_size=5, stride=1, padding=2)
            ),

            nn.Sequential(
                nonorm_Conv2d(64, 128, kernel_size=5, stride=2, padding=2),  # 72,72
